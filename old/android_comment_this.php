...
if(isset($_POST['myid']) && trim($_POST['myid']) != "" && isset($_POST['mypass']) && trim($_POST['mypass']) != "" && isset($_POST['news_id']) && trim($_POST['news_id']) != "" && isset($_POST['myshare_addition']) && trim($_POST['myshare_addition']) != "") {
require_once("config.php");
    ...
    if (mysqli_num_rows($result) != 0) {
          ...
          if($mypass == $dbpass && $dbflag == 0) {
            ...
            $column3_name = "date_time";
            $column4_name = "comment";

            $column1_value = $share_news_id;
            $column2_value = $myid;
            $column3_value = $date_time;
            $column4_value = $addNewsText2;
        ...
        $mentions = array_map(function($str){ return substr($str, 1); }, $mentions[0]);
          ...
          foreach($mentions as $mentionedUser){
                ...
                if (mysqli_num_rows($result) != 0) {
                      ...
                      $receiver_pot_name = trim($row["pot_name"]);
...
//////////////////////    FCM  START      /////////////////////////
  ...
  $myalert = $receiver_fullname . " mentioned you in a comment";
...
$fields = array(
      ...
      'data' => array(
        ...
        'not_type_real' => "comment",
        'not_pic' => $receiver_profile_picture,
        'not_title' => $title,
        'not_message' => $addNewsText,
        'not_image' => "",
        'not_video' => "",
        'not_text' => $myalert, 
        'not_pott_or_newsid' => $share_news_id, 
        'pott_name' => $receiver_pot_name, 
        'not_time' => $today  
        )
      );
...
//////////////////////    FCM  START      /////////////////////////
        ...
        $query = "SELECT investor_id, pot_name, first_name, last_name, verified_tag, profile_picture FROM investor WHERE investor_id = '$myid'";   
                ...
                $not_text = $linkee_full_name . " said something about your post";
...
$fields = array(
  ...
  $curl_result = curl_exec($curl_session);
            ...
            $column2_value = $myid;
            $column3_value = "comment";
            $column4_value = $addNewsText;
