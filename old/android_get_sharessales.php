...
//////////////////////    FCM  END      /////////////////////////                 
            ...
            if($news_sku == "0" || $gettype == "up"){
                  ...
                  $gettype = "down";
                    ...
                    for ($news_sku; $news_sku > 0; $news_sku--) { 
                        ...
                        $query = "SELECT * FROM shares4sale WHERE sku = $news_sku";
                          ...
                          if (mysqli_num_rows($result) != "0") {
                              ...
                              $f_Ids["news_id"][$f_Ids_cnt] = trim($row["shares_news_id"]);
      ...
      if($news != ""){
        ...
        //echo "host 333 -- " . $r["host"] . "<br>";
                  ...
                  $url= 'https://maps.googleapis.com/maps/api/geocode/json?latlng=' . $up4sale_item_location . '&sensor=false&key=AIzaSyCnDI9-fhpOUXvybVqw2T7_0kdHJ6Lt-vs';
