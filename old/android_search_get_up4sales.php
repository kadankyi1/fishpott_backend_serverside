            ...
            if($news_sku == "0" || $gettype == "up"){
                  ...
                  $gettype = "down";
                    ...
                    for ($news_sku; $news_sku > 0; $news_sku--) { 
                        ...
                        $query = "SELECT sku, up4sale_news_id FROM up4sale WHERE (UPPER(item_name) LIKE UPPER('%$search_txt%') OR UPPER(item_price) LIKE UPPER('%$search_txt%') OR  UPPER(item_description) LIKE UPPER('%$search_txt%')) AND sku = $news_sku";
