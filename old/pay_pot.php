...
<span onclick="hideBuyDiv(this);document.getElementById('inf_<?php echo $new_news_id; ?>').style.display = '';document.getElementById('pri_<?php echo $new_news_id; ?>').style.display = '';document.getElementById('buy_item_btn<?php echo $new_news_id; ?>').style.display = '';" id="close_<?php echo $new_news_id; ?>" data-newsid="<?php echo $new_news_id; ?>" class="w3-hover-text-grey w3-closebtn w3-right">
...
<?php if($item_8 > 1) { ?>
    <p id="quan_sec<?php echo $new_news_id; ?>" style="text-align: center">
            ...
            <input onclick="setSaleQuantity(this)" data-onecost="<?php echo $new_amt_pg; ?>" data-max="<?php echo $item_8; ?>" id="setq_<?php echo $new_news_id; ?>" data-newsid="<?php echo $new_news_id; ?>" style="width : 30%;" type="submit" value="Go" class="w3-btn w3-green w3-round">
    </p>
...
<?php } ?>
    ...
    <p style="text-align: center">TOTAL CHARGE      :      <span id="total_char_str<?php echo $new_news_id; ?>"><?php echo $new_amt_user_str;?></span></p>
        ...
        <input type=hidden name=merchant_key value="tk_c74ba68d-946a-ebc8-d908-e49dc61f89bc"  readonly="readonly" />
...
<div id = "wholebuy_div<?php echo $new_news_id; ?>">
  ...
  <span id="get_add_section<?php echo $new_news_id; ?>">
      <p style=" width: 100%; text-align: center;"><img src="../img/tick.png"  style="width: 20%; height: 20%;"><br><br><strong>You Must Meet With The Seller To Buy This Item<br><span style="color: grey; font-size: x-small;">Please ensure you meet in a public place</span></strong></p>
    </span>
    </p>
</div>
<?php }  else { ?>
...
?>
<div id = "wholebuy_div<?php echo $new_news_id; ?>">
   <span onclick="this.parentElement.style.display='none';document.getElementById('inf_<?php echo $new_news_id; ?>').style.display = '';document.getElementById('pri_<?php echo $new_news_id; ?>').style.display = '';document.getElementById('buy_ticket_btn<?php echo $new_news_id; ?>').style.display = '';" id="close_<?php echo $new_news_id; ?>" data-newsid="<?php echo $new_news_id; ?>" class="w3-hover-text-grey w3-closebtn">
    <i class="fa fa-remove"></i>
  </span>
    <p id="quan_sec<?php echo $new_news_id; ?>" style="text-align: center">
            ...
            <input onclick="setESaleQuantity(this)" data-onecost="<?php echo $new_amt_pg; ?>" data-max="1000000000" id="setq_<?php echo $new_news_id; ?>" data-newsid="<?php echo $new_news_id; ?>" style="width : 70%;" type="submit" value="Proceed" class="w3-btn w3-green w3-round">
    </p>
    ...
    <div class="w3-container" id="subm_fund<?php echo $new_news_id; ?>">
        <p style="width: 100%;text-align: center; align-content: center;">
        <input  class="w3-btn w3-green w3-round" type=submit value="Buy"   />
        <?php if(isset($pc) && $coins2curr > $new_amt_pg) {  ?>
...
<?php } else { ?>
<div id = "wholebuy_div<?php echo $new_news_id; ?>">
   <span  onclick="this.parentElement.style.display='none'" id="evtspan<?php echo $new_news_id; ?>" class="w3-hover-text-grey w3-closebtn">
    <i class="fa fa-remove"></i>
  </span>
  <span id="get_add_section<?php echo $new_news_id; ?>">
    <p style="text-align: center">FAILED</p>
