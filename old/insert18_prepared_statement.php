...
$stmt = $mysqli->prepare("INSERT INTO $table_name ($column1_name, $column2_name, $column3_name,  $column4_name, $column5_name, $column6_name, $column7_name, $column8_name, $column9_name, $column10_name, $column11_name, $column12_name, $column13_name, $column14_name, $column15_name, $column16_name, $column17_name, $column18_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
/* BK: always check whether the prepare() succeeded */
if ($stmt === false) {
    $done = 0;
} else {
    $stmt->bind_param("$pam1$pam2$pam3$pam4$pam5$pam6$pam7$pam8$pam9$pam10$pam11$pam12$pam13$pam14$pam15$pam16$pam17$pam18", $column1_value, $column2_value, $column3_value, $column4_value, $column5_value, $column6_value, $column7_value, $column8_value, $column9_value, $column10_value, $column11_value, $column12_value, $column13_value, $column14_value, $column15_value, $column16_value, $column17_value, $column18_value);
