            ...
            if($news_sku == "0" || $gettype == "up"){
                  ...
                  $gettype = "down";
                    ...
                    for ($news_sku; $news_sku > 0; $news_sku--) { 
                        ...
                        $query = "SELECT sku, f_news_id FROM fundraiser WHERE (UPPER(fundraiser_name) LIKE UPPER('%$search_txt%') OR UPPER(target_amount) LIKE UPPER('%$search_txt%')) AND sku = $news_sku";
