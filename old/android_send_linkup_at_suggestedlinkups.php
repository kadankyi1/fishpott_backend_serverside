...
if(isset($_POST['myid']) && trim($_POST['myid']) != "" && isset($_POST['mypass']) && trim($_POST['mypass']) != "" && isset($_POST['linkee_id']) && trim($_POST['linkee_id']) != "") {
require_once("config.php");

    include(ROOT_PATH . 'inc/db_connect.php');
    $linkee_id = trim($_POST['linkee_id']);
    ...
    if (mysqli_num_rows($result) != 0) {
          ...
          if (mysqli_num_rows($result) != "0") {
			  ...
			  echo "You are no longer linked to this pott. You will not see news from this pott"; exit;
                ...
                $query = "SELECT investor_id, fcm_token, fcm_token_web, fcm_token_ios, pot_name, first_name, last_name, verified_tag, profile_picture FROM investor WHERE investor_id = '$linkee_id'";   
        ...
        $query = "SELECT investor_id, pot_name, first_name, last_name, verified_tag, profile_picture FROM investor WHERE pot_name = '$linkee_id'";   
              ...
              $linkee_profile_picture = HTTP_HEAD . "://fishpott.com/pic_upload/" . $linkee_profile_picture; 
                ...
                $not_text = $linkee_full_name . " has linked to your pott to see posts from you.";
