...
$stmt = $mysqli->prepare("INSERT INTO $table_name ($column1_name, $column2_name, $column3_name,  $column4_name, $column5_name, $column6_name) VALUES (?, ?, ?, ?, ?, ?)");
/* BK: always check whether the prepare() succeeded */
if ($stmt === false) {
    $done = 0;
} else {
    $stmt->bind_param("$pam1$pam2$pam3$pam4$pam5$pam6", $column1_value, $column2_value, $column3_value, $column4_value, $column5_value, $column6_value);
