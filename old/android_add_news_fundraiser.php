...
if(isset($_POST['myid']) && trim($_POST['myid']) != "" && isset($_POST['mypass']) && trim($_POST['mypass']) != "" && isset($_POST['news_type']) && trim($_POST['news_type']) != "" && trim($_POST['news_type']) == "fundraiser" && isset($_POST['inputtor_type']) && trim($_POST['inputtor_type']) != "" && isset($_POST['this_currency']) && trim($_POST['this_currency']) != "" && isset($_POST['item_current_location']) && trim($_POST['item_current_location']) != "" && isset($_POST['item_name']) && trim($_POST['item_name']) != "" && isset($_POST['target']) && trim($_POST['target']) != "" && isset($_POST['addNewsText']) && trim($_POST['addNewsText']) != "") {
require_once("config.php");
    ...
    $this_currency = mysqli_real_escape_string($mysqli, $_POST['this_currency']);
   	$closing_date = mysqli_real_escape_string($mysqli, $_POST['item_current_location']);
    $fundraiser_name = mysqli_real_escape_string($mysqli, $_POST['item_name']);
    $target_amount = mysqli_real_escape_string($mysqli, $_POST['target']);
