      <div <?php //if(isset($type_of_view) && $type_of_view == "mobile") { echo "style = 'margin-right : 0px; margin-left : 0px; ";}  ?> class="w3-container w3-card-2 w3-white w3-round w3-margin" <?php if(isset($old_news_id_count)) { ?> id="<?php echo 'oldNewsDiv' . $old_news_id_count ?>" <?php if($old_news_id_count == 1 || $old_news_id_count == 19){ ?> data-newsku = "<?php echo $sku; ?>" <?php } ?> <?php } else { ?> id="<?php echo 'oldNewsDiv' . $news_id ?>" <?php } ?> ><br>
...
<?php } ?>
        ...
        <?php if($sn_type == "up4sale") { ?>
<button class="w3-btn w3-light-green w3-round" style="cursor: pointer;" value="<?php echo $news_id_ref; ?>" id="<?php echo "buy_item_btn" . $news_id_ref; ?>" onclick="showPayDiv4SharedNews(this)" data-type = "up4sale">
<label  style="cursor: pointer;" for="<?php echo "buy_item_btn" . $news_id_ref; ?>">
        ...
        <?php } elseif($sn_type == "shares4sale") { ?>
<button class="w3-btn w3-light-green w3-round" style="cursor: pointer;" value="<?php echo $news_id_ref; ?>" id="<?php echo "buy_shares_btn" . $news_id_ref; ?>" onclick="showPayDiv4SharedNews(this)" data-type = "shares4sale"><label for="<?php echo "buy_shares_btn" . $news_id_ref; ?>">
        ...
        <?php } elseif($sn_type == "fundraiser") { ?>
<button class="w3-btn w3-light-green w3-round" style="cursor: pointer;" value="<?php echo $news_id_ref; ?>" id="<?php echo "contribute_fundraiser_btn" . $news_id_ref; ?>" onclick="showPayDiv4SharedNews(this)" data-type = "fundraiser"><label for="<?php echo "contribute_fundraiser_btn" . $news_id_ref; ?>">        
<div class="tooltip"><i  id="<?php echo "buy_icon" . $news_id_ref; ?>" class="fa fa-money" style="cursor: pointer;color: black">
        ...
        <?php } elseif($sn_type == "event") { ?>
<button class="w3-btn w3-light-green w3-round" style="cursor: pointer;" value="<?php echo $news_id_ref; ?>" id="<?php echo "buy_ticket_btn" . $news_id_ref; ?>" onclick="showPayDiv4SharedNews(this)" data-type = "event"><label for="<?php echo "buy_ticket_btn" . $news_id_ref; ?>">       
...
<?php } ?>
        <?php if($type == "up4sale") { ?>
<button class="w3-btn  w3-round w3-light-green" style="cursor: pointer;" value="<?php echo $news_id; ?>" id="<?php echo "buy_item_btn" . $news_id; ?>" onclick="showPayDiv(this); " data-type = "up4sale"><label for="<?php echo "buy_item_btn" . $news_id; ?>" onclick="document.getElementById('commentholder<?php echo $news_id; ?>').style.display = 'block';">
...
<div class="tooltip"><i style="cursor: pointer;" id="<?php echo "buy_icon" . $news_id; ?>" class="fa fa-shopping-cart" style="color: black;">
        ...
        <?php } elseif($type == "shares4sale") { ?>
<button class="w3-btn  w3-round w3-light-green" style="cursor: pointer;" value="<?php echo $news_id; ?>" id="<?php echo "buy_shares_btn" . $news_id; ?>" onclick="showPayDiv(this)" data-type = "shares4sale">
...
<label for="<?php echo "buy_shares_btn" . $news_id; ?>" onclick="document.getElementById('commentholder<?php echo $news_id; ?>').style.display = 'block';">
        ...
        <?php } elseif($type == "fundraiser") { ?>
<button class="w3-btn  w3-round w3-light-green" style="cursor: pointer;" value="<?php echo $news_id; ?>" id="<?php echo "contribute_fundraiser_btn" . $news_id; ?>" onclick="showPayDiv(this)" data-type = "fundraiser"><label for="<?php echo "contribute_fundraiser_btn" . $news_id; ?>" onclick="document.getElementById('commentholder<?php echo $news_id; ?>').style.display = 'block';">        
...
<button class="w3-btn  w3-round w3-light-green" style="cursor: pointer;" value="<?php echo $news_id; ?>" id="<?php echo "buy_ticket_btn" . $news_id; ?>" onclick="showPayDiv(this)" data-type = "event">
