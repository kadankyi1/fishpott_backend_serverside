...
//////////////////////    FCM  END      /////////////////////////                 
      ...
      $result2 = $mysqli->query($query);
        ...
        $query="SELECT sku FROM newsfeed WHERE UPPER(news) LIKE UPPER('%$search_txt%') AND sku < $news_sku ORDER BY sku DESC";
            ...
            while($row2=$result2->fetch_array()) {
              ...
              if($ads_cnt_for_reset == 2 && count($ads) > $ads_cnt){
                ...
                $query = "SELECT * FROM newsfeed WHERE sku = $sku AND flag = 0";
                unset($add_set);
      ...
      if($news != ""){
        ...
        //echo "host 333 -- " . $r["host"] . "<br>";
                ...
                if (mysqli_num_rows($result) != "0") {
                      ...
                      $sn_news_video = trim($row["news_video"]);
