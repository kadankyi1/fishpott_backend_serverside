...
<?php } ?>
        <?php if($sn_type == "up4sale") { ?>
<button class="w3-btn  w3-round w3-light-green" style="cursor: pointer;" value="<?php echo $news_id_ref; ?>" id="<?php echo "buy_item_btn" . $news_id_ref; ?>" onclick="showPayDiv4SharedNews(this)" data-type = "up4sale">
<label for="<?php echo "buy_item_btn" . $news_id_ref; ?>">
        ...
        <?php } elseif($sn_type == "shares4sale") { ?>
<button  class="w3-btn  w3-round w3-light-green" style="cursor: pointer;" value="<?php echo $news_id_ref; ?>" id="<?php echo "buy_shares_btn" . $news_id_ref; ?>" onclick="showPayDiv4SharedNews(this)" data-type = "shares4sale"><label for="<?php echo "buy_shares_btn" . $news_id_ref; ?>">
        <div class="tooltip"><i class="fa fa-shopping-cart" id="<?php echo "buy_icon" . $news_id_ref; ?>" style="cursor: pointer; color: black">
...
<button  class="w3-btn  w3-round w3-light-green" style="cursor: pointer;" value="<?php echo $news_id_ref; ?>" id="<?php echo "contribute_fundraiser_btn" . $news_id_ref; ?>" onclick="showPayDiv4SharedNews(this)" data-type = "fundraiser"><label for="<?php echo "contribute_fundraiser_btn" . $news_id_ref; ?>">        
  <div class="tooltip"><i class="fa fa-money" id="<?php echo "buy_icon" . $news_id_ref; ?>" style="cursor: pointer; color: black">
        ...
        <?php } elseif($sn_type == "event") { ?>
<button class="w3-btn  w3-round w3-light-green" style="cursor: pointer;" value="<?php echo $news_id_ref; ?>" id="<?php echo "buy_ticket_btn" . $news_id_ref; ?>" onclick="showPayDiv4SharedNews(this)" data-type = "event">
...
<div class="tooltip"><i class="fa fa-shopping-cart" id="<?php echo "buy_icon" . $news_id; ?>" style="cursor: pointer; color: black;">
        ...
        <?php } elseif($type == "shares4sale") { ?>
<button class="w3-btn  w3-round w3-light-green" style="cursor: pointer;" value="<?php echo $news_id; ?>" id="<?php echo "buy_shares_btn" . $news_id; ?>" onclick="showPayDiv(this)" data-type = "shares4sale"><label for="<?php echo "buy_shares_btn" . $news_id; ?>" onclick="document.getElementById('commentholder<?php echo $news_id; ?>').style.display = 'block';">
        <div class="tooltip"><i class="fa fa-shopping-cart" id="<?php echo "buy_icon" . $news_id; ?>" style="cursor: pointer; color: black">
...
<div class="tooltip"><i class="fa fa-money" id="<?php echo "buy_icon" . $news_id; ?>" style="cursor: pointer; color: green">
        ...
        <?php } elseif($type == "event") { ?>
<button  class="w3-btn  w3-round w3-light-green" style="cursor: pointer;" value="<?php echo $news_id; ?>" id="<?php echo "buy_ticket_btn" . $news_id; ?>" onclick="showPayDiv(this)" data-type = "event"><label for="<?php echo "buy_ticket_btn" . $news_id; ?>" onclick="document.getElementById('commentholder<?php echo $news_id; ?>').style.display = 'block';">        
        <div class="tooltip"><i class="fa fa-shopping-cart"  id="<?php echo "buy_icon" . $news_id; ?>" style="cursor: pointer; color: black;">
