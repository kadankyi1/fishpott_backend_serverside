      <div class="w3-card w3-white w3-margin-bottom w3-round" style="width: 100%; margin-right: -40px; <?php if(isset($old_news_id_count)) { ?> id="<?php echo 'oldNewsDiv' . $old_news_id_count ?>" <?php if($old_news_id_count == 1 || $old_news_id_count == 19){ ?> data-newsku = "<?php echo $sku; ?>" <?php } ?> <?php } else { ?> id="<?php echo 'oldNewsDiv' . $news_id ?>" <?php } ?> ><br>
