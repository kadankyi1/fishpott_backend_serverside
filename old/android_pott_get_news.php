...
if(
    ...
    $this_pott_sys_id = mysqli_real_escape_string($mysqli, $_POST['pott_sys_id']);
    ...
    $this_pott_sys_id = trim($this_pott_sys_id);
          	    ...
          	    if($gettype == "down"){
    				...
    				for ($i; $i > 0; $i--) { 
    					...
    					if($ads_cnt_for_reset == 2 && count($ads) > $ads_cnt){
    						...
    						$query = "SELECT * FROM newsfeed WHERE sku = $i AND flag = 0 AND inputtor_id = '$this_pott_sys_id'";
    						unset($add_set);
